            ...
            <!-- DASHBOARD -->
                ...
                <li class="nav-item dropdown <?php if ($page_name == 'class_routine') echo 'opened active';?> ">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span><?php echo get_phrase('class_routine'); ?><i class="entypo-right"></i></span>
                    </a>
                    ...
                    ?>
                        <li class="dropdown-content ">
                            <a href="<?php echo base_url(); ?>index.php?parents/class_routine/<?php echo urlencode($row['student_id']);?>">
                ...
                if ($page_name == 'marks') echo 'opened active';?> ">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span><?php echo get_phrase('exam_marks'); ?><i class="entypo-right"></i></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <?php 
                        foreach ($children_of_parent as $row):
                    ?>
                        <li class="dropdown-content ">
                            <a href="<?php echo base_url(); ?>index.php?parents/marks/<?php echo urlencode($row['student_id']);?>">
                                <span><i class="entypo-dot"></i> <?php echo $row['name'];?></span>
                            </a>
                        </li>
                    <?php endforeach;?>
